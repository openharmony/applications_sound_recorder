...
class GlobalContext {
  ...
  public getServiceAbilityContext(): Context {
    return this.getContext(Ctx.SERVICE_ABILITY);
  }

  /* instrument ignore next */
  public setServiceAbilityContext(ctx: Context): void {
    this.setContext(Ctx.SERVICE_ABILITY, ctx);
  }
